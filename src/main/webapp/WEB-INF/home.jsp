...
<%@ page import="am.itspace.mytodo.model.enums.Status" %>
            ...
            <div class="col col-11 mx-auto">
                ...
                <div class="row bg-white rounded shadow-sm p-2 add-todo-wrapper align-items-center justify-content-center">
                    ...
                    <div class="col-auto m-0 px-2 d-flex align-items-center">
                        <input type="date" name="finishedDate" style="color: #007bff" data-toggle="tooltip">
                    </div>
        ...
        <div class="col mx-auto">
            ...
            <div class="row px-3 align-items-center todo-item rounded">
                ...
                <div class="col-auto m-1 p-0 d-flex align-items-center">
                    ...
                    <a href="/todos/done?id=<%=toDo.getId()%>">
                        <h2 class="m-0 p-0">
                    ...
                    <%} else { %>
                    <a href="/todos/update?id=<%=toDo.getId()%>"><h2 class="m-0 p-0">
                ...
                <div class="col-auto m-1 p-0 px-3">
                    <div class="row">
                        <div class="col-auto d-flex align-items-center rounded bg-white border border-warning">
                            ...
                            <h6 class="text my-2 pr-2"><%=DateUtil.dateToString(toDo.getFinishedDate())%>
                            </h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-auto m-1 p-0 todo-actions">
                    <div class="row d-flex align-items-center justify-content-end">
                        ...
                        <h5 class="m-0 p-0 px-2">
                            <a href="/todos/update?id=<%=toDo.getId()%>" class="fa fa-pencil text-info btn m-0 p-0"
                               data-toggle="tooltip" data-placement="bottom"
                               title="Edit todo"></a>
                        </h5>
                        <% } %>
                        <h5 class="m-0 p-0 px-2">
                            <a href="/todos/delete?id=<%=toDo.getId()%>" class="fa fa-trash-o text-danger btn m-0 p-0"
                               data-toggle="tooltip"
                    ...
                    <div class="row todo-created-info">
                        <div class="col-auto d-flex align-items-center pr-2">
                            ...
                            <label class="date-label my-2 text-black-50"><%=DateUtil.dateToString(toDo.getCreatedDate())%>
                            </label>
                        </div>
                    </div>
                </div>
